    ...
    <div className="relative w-full max-w-[260px] mx-auto">
      <svg viewBox="0 0 200 340" className="w-full h-auto" aria-label="Body map">
        ...
        <g>
          ...
          {/* Arms */}
          <path
            d="M62 72 Q48 84 46 110 Q44 132 50 156 L58 158 Q56 132 58 112 Q60 90 70 78 Z"
            fill="url(#bodyFill)"
            stroke="oklch(0.85 0.01 250)"
            strokeWidth="1.5"
          />
          <path
            d="M138 72 Q152 84 154 110 Q156 132 150 156 L142 158 Q144 132 142 112 Q140 90 130 78 Z"
            fill="url(#bodyFill)"
            stroke="oklch(0.85 0.01 250)"
            strokeWidth="1.5"
          />
          {/* Legs */}
          <path
            d="M70 178 Q72 220 78 260 L82 314 Q84 322 92 322 Q98 322 100 314 L102 264 Q102 220 100 178 Z"
            fill="url(#bodyFill)"
            stroke="oklch(0.85 0.01 250)"
            strokeWidth="1.5"
          />
          <path
            d="M130 178 Q128 220 122 260 L118 314 Q116 322 108 322 Q102 322 100 314 L98 264 Q98 220 100 178 Z"
            fill="url(#bodyFill)"
            stroke="oklch(0.85 0.01 250)"
            strokeWidth="1.5"
          />
      ...
      <div className="flex items-center justify-center gap-2 mt-2 text-[9px] text-muted-foreground">
        ...
        <span className="inline-flex items-center gap-1">
          <span className="h-2 w-2 rounded-full bg-warn/70" /> 1-3
        </span>
        <span className="inline-flex items-center gap-1">
          <span className="h-2 w-2 rounded-full bg-warn" /> 4-6
        </span>
        <span className="inline-flex items-center gap-1">
          <span className="h-2 w-2 rounded-full bg-destructive" /> 7+
        </span>
      </div>
    </div>
  );
